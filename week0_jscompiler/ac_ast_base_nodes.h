...
#ifndef ALTERED_CARBON__JS__AC_AST_BASE_NODES_H_
#define ALTERED_CARBON__JS__AC_AST_BASE_NODES_H_
...
#define TOKEN_POS \
  make_unique<ACLexPosition>(!!ptoken_ ? ptoken_->pos_ : nullptr)
...
protected:
  ...
  virtual Value* acceptInternal(ACAstVisitable*) const;
...
public:
  ...
  ACAstBaseNode (
      ...
      bool present_final_gift = false);
  virtual ~ACAstBaseNode() {}

  virtual Value* accept(ACAstVisitable*, bool giveRawGift = false) const;
  virtual Value* accept(
      ACAstVisitable*, const ACAstVisitable::ASTContext, bool giveRawGift = false) const;
...
public:
  ACAstExpressionNode(PPOSITION pos, PBaseNode expr = nullptr,
    ...
    // Code generation visitor API.
  void dumpGraph(std::ostream& o = std::cout) const override;
...
public:
  ACAstStatementNode(PPOSITION pos, PBaseNode stmt = nullptr,
      ...
      const AstNodeSubType sub_type = AST_SUB_GENERAL,
      const bool present_final_gift = false);
...
#endif  // ALTERED_CARBON__JS__AC_AST_BASE_NODES_H_
