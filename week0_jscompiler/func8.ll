...
exec.bb:                                          ; preds = %init.bb
  ...
  %12 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %ptr1, i32 0, i32 2
  %13 = bitcast %union.anon.6* %12 to %"cls.acjs::JsVariantFunc"*
  %14 = getelementptr inbounds %"cls.acjs::JsVariantFunc", %"cls.acjs::JsVariantFunc"* %13, i32 0, i32 0
  store void (%"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"**, i64)* @_ZN3_js6_anon0EPN14altered_carbon2js9JsVariantEN4llvm8ArrayRefIS3_EE, void (%"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"**, i64)** %14, align 8
  %15 = getelementptr inbounds %"cls.acjs::JsVariantFunc", %"cls.acjs::JsVariantFunc"* %13, i32 0, i32 1
  store i32* getelementptr inbounds ([7 x i32], [7 x i32]* @.wstr, i32 0, i32 0), i32** %15, align 8
...
exit.bb:                                          ; preds = %npe.bbe
  %19 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %0, %"cls.acjs::JsVariant"* dereferenceable(56) %jsret)
...
err.bb:                                           ; preds = %exec.bb
  %24 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %ptr2, i32 0, i32 2
  %25 = bitcast %union.anon.6* %24 to i8**
  store i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), i8** %25, align 8
  br label %npe.bbe
...
call.bb:                                          ; preds = %npe.bb
  ...
  %27 = getelementptr inbounds [1 x %"cls.acjs::JsVariant"*], [1 x %"cls.acjs::JsVariant"*]* %ptr5, i32 0, i32 0
  %28 = getelementptr inbounds %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"** %27, i64 0
  store %"cls.acjs::JsVariant"* %ptr, %"cls.acjs::JsVariant"** %28, align 8
  call void %26(%"cls.acjs::JsVariant"* %ptr6, %"cls.acjs::JsVariant"* null, %"cls.acjs::JsVariant"** %27, i64 1)
  br label %npe.bbe
...
err.bb3:                                          ; preds = %npe.bb
  ...
  store i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i8** %30, align 8
  br label %npe.bbe
}
