...
exec.bb:                                          ; preds = %init.bb
  ...
  %19 = getelementptr inbounds [4 x %"cls.acjs::JsVariant"*], [4 x %"cls.acjs::JsVariant"*]* %ptr4, i32 0, i32 0
  br label %initarr.bb

exit.bb:                                          ; preds = %initarr.bbe
  %20 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %0, %"cls.acjs::JsVariant"* dereferenceable(56) %ptr7)
...
initarr.bbe:                                      ; preds = %initarr.bb
  ...
  %26 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %25, %"cls.acjs::JsVariant"* %ptr)
  ...
  %29 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %28, %"cls.acjs::JsVariant"* %ptr1)
  ...
  %32 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %31, %"cls.acjs::JsVariant"* %ptr2)
  ...
  %35 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %34, %"cls.acjs::JsVariant"* %ptr3)
  ...
  store %"cls.acjs::JsVariant"** %19, %"cls.acjs::JsVariant"*** %arrptr, align 8
  store i64 4, i64* %cntptr
  %37 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERN4llvm8ArrayRefIPS1_EE(%"cls.acjs::JsVariant"* %ptr6, %"class.llvm::ArrayRef"* %ptr5)
