...
init.bb:
  ...
  %ptr7 = alloca [7 x %"cls.acjs::JsVariant"*], align 16
...
exec.bb:                                          ; preds = %init.bb
  ...
  %26 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEPKw(%"cls.acjs::JsVariant"* %ptr3, i32* getelementptr inbounds ([6 x i32], [6 x i32]* @.wstr, i32 0, i32 0))
  %27 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEx(%"cls.acjs::JsVariant"* %ptr4, i64 4)
  %28 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEx(%"cls.acjs::JsVariant"* %ptr5, i64 5)
  %29 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEx(%"cls.acjs::JsVariant"* %ptr6, i64 6)
  %newalloc = call i8* @_Znam(i64 400)
  %30 = bitcast i8* %newalloc to i64*
  store i64 7, i64* %30, align 16
  %31 = getelementptr inbounds i8, i8* %newalloc, i64 8
  %32 = bitcast i8* %31 to %"cls.acjs::JsVariant"*
  %33 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %32, i64 7
  %34 = getelementptr inbounds [7 x %"cls.acjs::JsVariant"*], [7 x %"cls.acjs::JsVariant"*]* %ptr7, i32 0, i32 0
  br label %initarr.bb

exit.bb:                                          ; preds = %initarr.bbe
  %35 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %0, %"cls.acjs::JsVariant"* dereferenceable(56) %ptr12)
...
initarr.bb:                                       ; preds = %initarr.bb, %exec.bb
  %iter = phi %"cls.acjs::JsVariant"* [ %32, %exec.bb ], [ %38, %initarr.bb ]
  %36 = bitcast %"cls.acjs::JsVariant"* %iter to i32 (...)***
  ...
  %37 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %iter, i32 0, i32 1
  store i32 1, i32* %37, align 8
  %38 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %iter, i64 1
  %39 = icmp eq %"cls.acjs::JsVariant"* %38, %33
  br i1 %39, label %initarr.bbe, label %initarr.bb

initarr.bbe:                                      ; preds = %initarr.bb
  %40 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %32, i64 0
  %41 = getelementptr inbounds %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"** %34, i64 0
  %42 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %40, %"cls.acjs::JsVariant"* %ptr)
  store %"cls.acjs::JsVariant"* %40, %"cls.acjs::JsVariant"** %41, align 8
  %43 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %32, i64 1
  %44 = getelementptr inbounds %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"** %34, i64 1
  %45 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %43, %"cls.acjs::JsVariant"* %ptr1)
  store %"cls.acjs::JsVariant"* %43, %"cls.acjs::JsVariant"** %44, align 8
  %46 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %32, i64 2
  %47 = getelementptr inbounds %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"** %34, i64 2
  %48 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %46, %"cls.acjs::JsVariant"* %ptr2)
  store %"cls.acjs::JsVariant"* %46, %"cls.acjs::JsVariant"** %47, align 8
  %49 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %32, i64 3
  %50 = getelementptr inbounds %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"** %34, i64 3
  %51 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %49, %"cls.acjs::JsVariant"* %ptr3)
  store %"cls.acjs::JsVariant"* %49, %"cls.acjs::JsVariant"** %50, align 8
  %52 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %32, i64 4
  %53 = getelementptr inbounds %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"** %34, i64 4
  %54 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %52, %"cls.acjs::JsVariant"* %ptr4)
  store %"cls.acjs::JsVariant"* %52, %"cls.acjs::JsVariant"** %53, align 8
  %55 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %32, i64 5
  %56 = getelementptr inbounds %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"** %34, i64 5
  %57 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %55, %"cls.acjs::JsVariant"* %ptr5)
  store %"cls.acjs::JsVariant"* %55, %"cls.acjs::JsVariant"** %56, align 8
  %58 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %32, i64 6
  %59 = getelementptr inbounds %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"** %34, i64 6
  %60 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %58, %"cls.acjs::JsVariant"* %ptr6)
  store %"cls.acjs::JsVariant"* %58, %"cls.acjs::JsVariant"** %59, align 8
  %ptr8 = alloca %"class.llvm::ArrayRef", align 8
  %arrptr = getelementptr inbounds %"class.llvm::ArrayRef", %"class.llvm::ArrayRef"* %ptr8, i32 0, i32 0
  %cntptr = getelementptr inbounds %"class.llvm::ArrayRef", %"class.llvm::ArrayRef"* %ptr8, i32 0, i32 1
  store %"cls.acjs::JsVariant"** %34, %"cls.acjs::JsVariant"*** %arrptr, align 8
  store i64 7, i64* %cntptr
  %61 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERN4llvm8ArrayRefIPS1_EE(%"cls.acjs::JsVariant"* %ptr9, %"class.llvm::ArrayRef"* %ptr8)
  %62 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %ptr10, %"cls.acjs::JsVariant"* %ptr9)
  %63 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %ptr11, %"cls.acjs::JsVariant"* %ptr10)
  %64 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %ptr12, %"cls.acjs::JsVariant"* %ptr10)
  br label %exit.bb
}
