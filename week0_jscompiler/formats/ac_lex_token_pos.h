...
#ifndef ALTERED_CARBON__JS__AC_LEX_TOKEN_POS
#define ALTERED_CARBON__JS__AC_LEX_TOKEN_POS
...
enum ACLexTokenType {
  ...
  TK_PAREN_RIGHT          = 15,
  TK_PAREN_LEFT           = 16,
  TK_CURLY_BRACKET_LEFT   = 17,
  TK_CURLY_BRACKET_RIGHT  = 18, 
  TK_SQUARE_BRACKET_LEFT  = 19,
  TK_SQUARE_BRACKET_RIGHT = 20,
  TK_SEMICOLON            = 21,
...
public:
  ...
  virtual ~ACLexToken() {}
  virtual ACLexNumber numberValue() const { return ACLexNumber((long double) 0.0); }
...
public:
  ...
  virtual ACLexNumber numberValue() const { return number_; }
...
public:
  ...
  virtual void dump(std::ostream& os) const;
  virtual PLEXREGEX regexValue() { return std::move(regex_); }
...
#endif  // ALTERED_CARBON__JS__AC_LEX_TOKEN_POS
