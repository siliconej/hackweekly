...
// variable, rather allocated from HEAP and held by a local std::unique
// variable.
///////////////////////////////////////////////////////////////////////////////////

///////////////////////////////////////////////////////////////////////////////////
ACAstIdentifierParam::ACAstIdentifierParam(PPOSITION pos,
                                           PVariantNode param_name,
                                           PBaseNode default_value,
...
///////////////////////////////////////////////////////////////////////////////////
ACAstObjectParam::ACAstObjectParam(PPOSITION pos, PBaseNodeList properties,
                                   const AstNodeType type,
                                   const AstNodeSubType sub_type)
    : ACAstObjectNode(std::move(pos), std::move(properties), type, sub_type) {}

///////////////////////////////////////////////////////////////////////////////////
ACAstFunctionNode::ACAstFunctionNode(PPOSITION pos, PVariantNode func_name,
                                     PBaseNodeList params, PBaseNode block,
                                     const AstNodeType type,
                                     const AstNodeSubType sub_type)
    : ACAstBaseNode(std::move(pos), type, sub_type),
      object_name_(std::move(func_name)),
...
///////////////////////////////////////////////////////////////////////////////////
ACAstClassNode::ACAstClassNode(PPOSITION pos, PVariantNode class_name,
                               PBaseNodeList params, PBaseNode block,
                               const AstNodeType type,
                               const AstNodeSubType sub_type)
    : ACAstFunctionNode(std::move(pos), std::move(class_name),
                        std::move(params), std::move(block), type, sub_type) {}
