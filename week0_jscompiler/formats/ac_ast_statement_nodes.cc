...
ACAstExpressionStatement::ACAstExpressionStatement(
    PPOSITION pos, PBaseNode expr, const AstNodeType type,
...
//// IfElseStatement
/////////////////////////////////////////////////////////////////
ACAstIfElseStatement::ACAstIfElseStatement(PPOSITION pos, PBaseNode condition,
                                           PBaseNode true_block,
                                           PBaseNode false_block,
...
ACAstVariableDeclListStmt::ACAstVariableDeclListStmt(
    PPOSITION pos, PBaseNodeList var_list, const AstNodeType type,
    const AstNodeSubType sub_type)
...
ACAstLexicalDeclListStmt::ACAstLexicalDeclListStmt(
    PPOSITION pos, PBaseNodeList var_list, const ACLexTokenType lex_type,
    const bool in_for_statement, const AstNodeType type,
    const AstNodeSubType sub_type)
    : ACAstVariableDeclListStmt(std::move(pos), std::move(var_list), type,
                                sub_type),
      lexical_type_(lex_type),
      in_for_statement_(in_for_statement) {}

void ACAstLexicalDeclListStmt::dumpChildNodes(std::ostream& os) const {
  switch (lexical_type_) {
    case TK_RSV_CONST:
      os << "*CONST*";
      break;
    case TK_RSV_LET:
...
//// DoWhileStatement
////////////////////////////////////////////////////////////////
ACAstDoWhileStatement::ACAstDoWhileStatement(PPOSITION pos, PBaseNode condition,
                                             PBaseNode do_body,
                                             const AstNodeType type,
                                             const AstNodeSubType sub_type)
    : ACAstStatementNode(std::move(pos), std::move(condition), type, sub_type) {
...
//// WhileStatement
//////////////////////////////////////////////////////////////////
ACAstWhileStatement::ACAstWhileStatement(PPOSITION pos, PBaseNode condition,
                                         PBaseNode while_body,
                                         const AstNodeType type,
                                         const AstNodeSubType sub_type)
    : ACAstStatementNode(std::move(pos), std::move(condition), type, sub_type) {
...
//// ForStatement
////////////////////////////////////////////////////////////////////
ACAstForStatement::ACAstForStatement(PPOSITION pos, PBaseNode init_var,
...
//// ForInStatement
//////////////////////////////////////////////////////////////////
ACAstForInStatement::ACAstForInStatement(PPOSITION pos, PBaseNode lhs_expr,
                                         PBaseNode rhs_expr,
                                         PBaseNode body_stmt,
                                         const AstNodeType type,
                                         const AstNodeSubType sub_type)
...
//// ReturnStatement
/////////////////////////////////////////////////////////////////
ACAstReturnStatement::ACAstReturnStatement(PPOSITION pos, PBaseNode stmt,
                                           const AstNodeType type,
                                           const AstNodeSubType sub_type)
...
//// ContinueStatement
///////////////////////////////////////////////////////////////
ACAstContinueStatement::ACAstContinueStatement(PPOSITION pos, PBaseNode label,
                                               const AstNodeType type,
                                               const AstNodeSubType sub_type)
...
//// BreakStatement
//////////////////////////////////////////////////////////////////
ACAstBreakStatement::ACAstBreakStatement(PPOSITION pos, PBaseNode label,
                                         const AstNodeType type,
                                         const AstNodeSubType sub_type)
    : ACAstStatementNode(std::move(pos), std::move(label), type, sub_type) {}
...
//// ThrowStatement
//////////////////////////////////////////////////////////////////
ACAstThrowStatement::ACAstThrowStatement(PPOSITION pos, PBaseNode expr,
                                         const AstNodeType type,
                                         const AstNodeSubType sub_type)
    : ACAstStatementNode(std::move(pos), std::move(expr), type, sub_type) {}
...
//// TryCatchStatement
///////////////////////////////////////////////////////////////
ACAstTryCatchStatement::ACAstTryCatchStatement(PPOSITION pos,
                                               PBaseNode try_clause,
                                               PBaseNode catch_clause,
                                               PBaseNode finally_clause,
                                               const AstNodeType type,
                                               const AstNodeSubType sub_type)
    : ACAstStatementNode(std::move(pos), std::move(try_clause), type,
                         sub_type) {
...
//// CatchClause
/////////////////////////////////////////////////////////////////////
ACAstCatchClause::ACAstCatchClause(PPOSITION pos, PBaseNode condition,
                                   PBaseNode body, const AstNodeType type,
                                   const AstNodeSubType sub_type)
    : ACAstStatementNode(std::move(pos), std::move(condition), type, sub_type) {
...
//// SwitchStatement
/////////////////////////////////////////////////////////////////
ACAstSwitchStatement::ACAstSwitchStatement(PPOSITION pos, PBaseNode expr,
...
//// CaseClause
//////////////////////////////////////////////////////////////////////
ACAstCaseClause::ACAstCaseClause(PPOSITION pos, PBaseNode expr,
...
//// LabeledStatement
////////////////////////////////////////////////////////////////
ACAstLabeledStatement::ACAstLabeledStatement(PPOSITION pos, std::wstring label,
                                             PBaseNode stmt,
                                             const AstNodeType type,
                                             const AstNodeSubType sub_type)
    : ACAstStatementNode(std::move(pos), std::move(stmt), type, sub_type),
...
//// EmptyStatement
//////////////////////////////////////////////////////////////////
ACAstEmptyStatement::ACAstEmptyStatement(PPOSITION pos, const AstNodeType type,
                                         const AstNodeSubType sub_type)
    : ACAstStatementNode(std::move(pos), nullptr, type, sub_type) {}
