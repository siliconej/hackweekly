...
exec.bb:                                          ; preds = %init.bb
  %13 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEx(%"cls.acjs::JsVariant"* %ptr, i64 1)
  ...
  br i1 %18, label %npe.bb, label %err.bb

exit.bb:                                          ; preds = %npe.bbe
  %19 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %0, %"cls.acjs::JsVariant"* dereferenceable(56) %ptr7)
...
npe.bb:                                           ; preds = %exec.bb
  %20 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %ptr1, i32 0, i32 2
  %21 = bitcast %union.anon.6* %20 to %"cls.acjs::JsVariantFunc"*
  %22 = getelementptr inbounds %"cls.acjs::JsVariantFunc", %"cls.acjs::JsVariantFunc"* %21, i32 0, i32 0
  %23 = icmp ne void (%"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"**, i64)** %22, null
  br i1 %23, label %call.bb, label %err.bb3
...
npe.bbe:                                          ; preds = %call.bb, %err.bb3, %err.bb
  ...
  %24 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %ptr6, %"cls.acjs::JsVariant"* %jsret)
  %25 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %ptr7, %"cls.acjs::JsVariant"* %ptr6)
  br label %exit.bb
...
call.bb:                                          ; preds = %npe.bb
  %26 = load void (%"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"**, i64)*, void (%"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"**, i64)** %22, align 8
  %27 = getelementptr inbounds [1 x %"cls.acjs::JsVariant"*], [1 x %"cls.acjs::JsVariant"*]* %ptr4, i32 0, i32 0
  %28 = getelementptr inbounds %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"** %27, i64 0
  store %"cls.acjs::JsVariant"* %ptr2, %"cls.acjs::JsVariant"** %28, align 8
  call void %26(%"cls.acjs::JsVariant"* %ptr5, %"cls.acjs::JsVariant"* null, %"cls.acjs::JsVariant"** %27, i64 1)
  br label %npe.bbe
