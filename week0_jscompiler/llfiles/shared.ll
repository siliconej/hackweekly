...
define i32 @main(i32, i8**) #0 {
  ...
  %7 = alloca %"class.std::__1::__shared_count"*, align 8
  ...
  %17 = alloca %"struct.std::__1::shared_ptr<altered_carbon::js::ACJsValue>::__nat", align 4
  %18 = alloca %"class.std::__1::shared_ptr", align 8
  store i32 0, i32* %13, align 4
  store i32 %0, i32* %14, align 4
  store i8** %1, i8*** %15, align 8
  %19 = call i8* @_Znwm(i64 16) #8
  %20 = bitcast i8* %19 to %"class.altered_carbon::js::ACJsBoolean"*
  call void @_ZN14altered_carbon2js11ACJsBooleanC1Eb(%"class.altered_carbon::js::ACJsBoolean"* %20, i1 zeroext true)
  %21 = bitcast %"struct.std::__1::shared_ptr<altered_carbon::js::ACJsValue>::__nat"* %17 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 4 %21, i8 0, i64 4, i1 false)
  %22 = getelementptr inbounds %"struct.std::__1::shared_ptr<altered_carbon::js::ACJsValue>::__nat", %"struct.std::__1::shared_ptr<altered_carbon::js::ACJsValue>::__nat"* %17, i32 0, i32 0
  %23 = load i32, i32* %22, align 4
  call void @_ZNSt3__110shared_ptrIN14altered_carbon2js9ACJsValueEEC1INS2_11ACJsBooleanEEEPT_NS_9enable_ifIXsr14is_convertibleIS8_PS3_EE5valueENS4_5__natEE4typeE(%"class.std::__1::shared_ptr"* %16, %"class.altered_carbon::js::ACJsBoolean"* %20, i32 %23)
  store %"class.std::__1::shared_ptr"* %18, %"class.std::__1::shared_ptr"** %11, align 8
  store %"class.std::__1::shared_ptr"* %16, %"class.std::__1::shared_ptr"** %12, align 8
  %24 = load %"class.std::__1::shared_ptr"*, %"class.std::__1::shared_ptr"** %11, align 8
  %25 = load %"class.std::__1::shared_ptr"*, %"class.std::__1::shared_ptr"** %12, align 8
  store %"class.std::__1::shared_ptr"* %24, %"class.std::__1::shared_ptr"** %9, align 8
  store %"class.std::__1::shared_ptr"* %25, %"class.std::__1::shared_ptr"** %10, align 8
  %26 = load %"class.std::__1::shared_ptr"*, %"class.std::__1::shared_ptr"** %9, align 8
  %27 = getelementptr inbounds %"class.std::__1::shared_ptr", %"class.std::__1::shared_ptr"* %26, i32 0, i32 0
  %28 = load %"class.std::__1::shared_ptr"*, %"class.std::__1::shared_ptr"** %10, align 8
  %29 = getelementptr inbounds %"class.std::__1::shared_ptr", %"class.std::__1::shared_ptr"* %28, i32 0, i32 0
  %30 = load %"class.altered_carbon::js::ACJsValue"*, %"class.altered_carbon::js::ACJsValue"** %29, align 8
  store %"class.altered_carbon::js::ACJsValue"* %30, %"class.altered_carbon::js::ACJsValue"** %27, align 8
  %31 = getelementptr inbounds %"class.std::__1::shared_ptr", %"class.std::__1::shared_ptr"* %26, i32 0, i32 1
  %32 = load %"class.std::__1::shared_ptr"*, %"class.std::__1::shared_ptr"** %10, align 8
  %33 = getelementptr inbounds %"class.std::__1::shared_ptr", %"class.std::__1::shared_ptr"* %32, i32 0, i32 1
  %34 = load %"class.std::__1::__shared_weak_count"*, %"class.std::__1::__shared_weak_count"** %33, align 8
  store %"class.std::__1::__shared_weak_count"* %34, %"class.std::__1::__shared_weak_count"** %31, align 8
  %35 = getelementptr inbounds %"class.std::__1::shared_ptr", %"class.std::__1::shared_ptr"* %26, i32 0, i32 1
  %36 = load %"class.std::__1::__shared_weak_count"*, %"class.std::__1::__shared_weak_count"** %35, align 8
  %37 = icmp ne %"class.std::__1::__shared_weak_count"* %36, null
  br i1 %37, label %38, label %50

; <label>:38:                                     ; preds = %2
  %39 = getelementptr inbounds %"class.std::__1::shared_ptr", %"class.std::__1::shared_ptr"* %26, i32 0, i32 1
  %40 = load %"class.std::__1::__shared_weak_count"*, %"class.std::__1::__shared_weak_count"** %39, align 8
  store %"class.std::__1::__shared_weak_count"* %40, %"class.std::__1::__shared_weak_count"** %8, align 8
  %41 = load %"class.std::__1::__shared_weak_count"*, %"class.std::__1::__shared_weak_count"** %8, align 8
  %42 = bitcast %"class.std::__1::__shared_weak_count"* %41 to %"class.std::__1::__shared_count"*
  store %"class.std::__1::__shared_count"* %42, %"class.std::__1::__shared_count"** %7, align 8
  %43 = load %"class.std::__1::__shared_count"*, %"class.std::__1::__shared_count"** %7, align 8
  %44 = getelementptr inbounds %"class.std::__1::__shared_count", %"class.std::__1::__shared_count"* %43, i32 0, i32 1
  store i64* %44, i64** %4, align 8
  %45 = load i64*, i64** %4, align 8
  store i64 1, i64* %5, align 8
  %46 = load i64, i64* %5, align 8
  %47 = atomicrmw add i64* %45, i64 %46 monotonic
  %48 = add i64 %47, %46
...
; <label>:50:                                     ; preds = %2, %38
  store %"class.std::__1::shared_ptr"* %18, %"class.std::__1::shared_ptr"** %3, align 8
  %51 = load %"class.std::__1::shared_ptr"*, %"class.std::__1::shared_ptr"** %3, align 8
  %52 = getelementptr inbounds %"class.std::__1::shared_ptr", %"class.std::__1::shared_ptr"* %51, i32 0, i32 0
  %53 = load %"class.altered_carbon::js::ACJsValue"*, %"class.altered_carbon::js::ACJsValue"** %52, align 8
  %54 = bitcast %"class.altered_carbon::js::ACJsValue"* %53 to %"class.altered_carbon::js::ACJsValue"* (%"class.altered_carbon::js::ACJsValue"*)***
  %55 = load %"class.altered_carbon::js::ACJsValue"* (%"class.altered_carbon::js::ACJsValue"*)**, %"class.altered_carbon::js::ACJsValue"* (%"class.altered_carbon::js::ACJsValue"*)*** %54, align 8
  %56 = getelementptr inbounds %"class.altered_carbon::js::ACJsValue"* (%"class.altered_carbon::js::ACJsValue"*)*, %"class.altered_carbon::js::ACJsValue"* (%"class.altered_carbon::js::ACJsValue"*)** %55, i64 22
  %57 = load %"class.altered_carbon::js::ACJsValue"* (%"class.altered_carbon::js::ACJsValue"*)*, %"class.altered_carbon::js::ACJsValue"* (%"class.altered_carbon::js::ACJsValue"*)** %56, align 8
  %58 = call %"class.altered_carbon::js::ACJsValue"* %57(%"class.altered_carbon::js::ACJsValue"* %53)
  %59 = bitcast %"class.altered_carbon::js::ACJsValue"* %58 to i1 (%"class.altered_carbon::js::ACJsValue"*)***
  %60 = load i1 (%"class.altered_carbon::js::ACJsValue"*)**, i1 (%"class.altered_carbon::js::ACJsValue"*)*** %59, align 8
  %61 = getelementptr inbounds i1 (%"class.altered_carbon::js::ACJsValue"*)*, i1 (%"class.altered_carbon::js::ACJsValue"*)** %60, i64 3
  %62 = load i1 (%"class.altered_carbon::js::ACJsValue"*)*, i1 (%"class.altered_carbon::js::ACJsValue"*)** %61, align 8
  %63 = call zeroext i1 %62(%"class.altered_carbon::js::ACJsValue"* %58)
  %64 = zext i1 %63 to i32
  store i32 %64, i32* %13, align 4
  call void @_ZNSt3__110shared_ptrIN14altered_carbon2js9ACJsValueEED1Ev(%"class.std::__1::shared_ptr"* %18) #9
  call void @_ZNSt3__110shared_ptrIN14altered_carbon2js9ACJsValueEED1Ev(%"class.std::__1::shared_ptr"* %16) #9
