...
init.bb:
  ...
  %ptr7 = alloca [3 x %"cls.acjs::JsVariant"*], align 16
...
exec.bb:                                          ; preds = %init.bb
  %19 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEx(%"cls.acjs::JsVariant"* %ptr, i64 2)
  ...
  %24 = call %"cls.acjs::JsVariant"* @_ZNK14altered_carbon2js9JsVariant3mulEPS1_RKS1_(%"cls.acjs::JsVariant"* %ptr1, %"cls.acjs::JsVariant"* %ptr5, %"cls.acjs::JsVariant"* %ptr3)
  %25 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEx(%"cls.acjs::JsVariant"* %ptr6, i64 3)
  %newalloc = call i8* @_Znam(i64 176)
  %26 = bitcast i8* %newalloc to i64*
  store i64 3, i64* %26, align 16
  %27 = getelementptr inbounds i8, i8* %newalloc, i64 8
  %28 = bitcast i8* %27 to %"cls.acjs::JsVariant"*
  %29 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %28, i64 3
  %30 = getelementptr inbounds [3 x %"cls.acjs::JsVariant"*], [3 x %"cls.acjs::JsVariant"*]* %ptr7, i32 0, i32 0
  br label %initarr.bb

exit.bb:                                          ; preds = %initarr.bbe
  %31 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %0, %"cls.acjs::JsVariant"* dereferenceable(56) %ptr10)
...
initarr.bb:                                       ; preds = %initarr.bb, %exec.bb
  %iter = phi %"cls.acjs::JsVariant"* [ %28, %exec.bb ], [ %34, %initarr.bb ]
  %32 = bitcast %"cls.acjs::JsVariant"* %iter to i32 (...)***
  ...
  %33 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %iter, i32 0, i32 1
  store i32 1, i32* %33, align 8
  %34 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %iter, i64 1
  %35 = icmp eq %"cls.acjs::JsVariant"* %34, %29
  br i1 %35, label %initarr.bbe, label %initarr.bb

initarr.bbe:                                      ; preds = %initarr.bb
  %36 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %28, i64 0
  %37 = getelementptr inbounds %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"** %30, i64 0
  %38 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %36, %"cls.acjs::JsVariant"* %ptr4)
  store %"cls.acjs::JsVariant"* %36, %"cls.acjs::JsVariant"** %37, align 8
  %39 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %28, i64 1
  %40 = getelementptr inbounds %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"** %30, i64 1
  %41 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %39, %"cls.acjs::JsVariant"* %24)
  store %"cls.acjs::JsVariant"* %39, %"cls.acjs::JsVariant"** %40, align 8
  %42 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %28, i64 2
  %43 = getelementptr inbounds %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"** %30, i64 2
  %44 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %42, %"cls.acjs::JsVariant"* %ptr6)
  store %"cls.acjs::JsVariant"* %42, %"cls.acjs::JsVariant"** %43, align 8
  ...
  store %"cls.acjs::JsVariant"** %30, %"cls.acjs::JsVariant"*** %arrptr, align 8
  store i64 3, i64* %cntptr
  %45 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERN4llvm8ArrayRefIPS1_EE(%"cls.acjs::JsVariant"* %ptr9, %"class.llvm::ArrayRef"* %ptr8)
  %46 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %ptr10, %"cls.acjs::JsVariant"* %ptr9)
  br label %exit.bb
}
