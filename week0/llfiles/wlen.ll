; ModuleID = 'temp.bc'
source_filename = "wlen.cc"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.13.0"

@.str = private unnamed_addr constant [13 x i32] [i32 104, i32 101, i32 108, i32 108, i32 111, i32 32, i32 119, i32 111, i32 114, i32 108, i32 100, i32 46, i32 0], align 4
...
define i32 @main(i32, i8**) #0 {
  ...
  store i32* getelementptr inbounds ([13 x i32], [13 x i32]* @.str, i32 0, i32 0), i32** %6, align 8
