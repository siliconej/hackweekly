; ModuleID = 'postfix3.js'
source_filename = "postfix3.js"
...
exec.bb:                                          ; preds = %init.bb
  %9 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEd(%"cls.acjs::JsVariant"* %ptr, double 1.000000e+00)
  %10 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %ptr1, %"cls.acjs::JsVariant"* %ptr)
  call void @_ZN14altered_carbon2js9JsVariantmmEi(%"cls.acjs::JsVariant"* %ptr2, %"cls.acjs::JsVariant"* %ptr1, i32 0)
  %11 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantmmEv(%"cls.acjs::JsVariant"* %ptr1)
  %12 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %ptr3, %"cls.acjs::JsVariant"* %11)
  br label %exit.bb

exit.bb:                                          ; preds = %exec.bb
  %13 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %0, %"cls.acjs::JsVariant"* dereferenceable(56) %ptr3)
