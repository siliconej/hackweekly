; ModuleID = '/Users/ejiang/Projects/lls/ac/script74.js'
source_filename = "/Users/ejiang/Projects/lls/ac/script74.js"
...
exec.bb:                                          ; preds = %init.bb
  %7 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %vptr, i32 0, i32 1
  %8 = load i32, i32* %7, align 8
  %9 = icmp sle i32 %8, 6
  br i1 %9, label %assign.bb, label %fallback.bb

exit.bb:                                          ; preds = %copy.bbe
  %10 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %0, %"cls.acjs::JsVariant"* dereferenceable(56) %vptr2)
...
assign.bbe:                                       ; preds = %fallback.bb, %assign.bb
  ...
  call void @_ZN14altered_carbon2js9JsVariantmmEi(%"cls.acjs::JsVariant"* %vptr1, %"cls.acjs::JsVariant"* %vptr, i32 0)
  %16 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantmmEv(%"cls.acjs::JsVariant"* %vptr)
  %17 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %vptr2, i32 0, i32 1
  %18 = load i32, i32* %17, align 8
  %19 = icmp sle i32 %18, 6
  %20 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %16, i32 0, i32 1
  %21 = load i32, i32* %20, align 8
  %22 = icmp sle i32 %21, 6
  %23 = and i1 %19, %22
  br i1 %23, label %copy.bb, label %fallback.bb3

fallback.bb:                                      ; preds = %exec.bb
  %24 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEd(%"cls.acjs::JsVariant"* %vptr, double 1.000000e+00)
  br label %assign.bbe

copy.bb:                                          ; preds = %assign.bbe
  switch i32 %21, label %fallback.bb3 [
...
fallback.bb3:                                     ; preds = %copy.bb, %assign.bbe
  %25 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %vptr2, %"cls.acjs::JsVariant"* %16)
  br label %copy.bbe

caseerr.bb:                                       ; preds = %copy.bb
  store i32 %21, i32* %17, align 8
  %26 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %16, i32 0, i32 2
...
casebln.bb:                                       ; preds = %copy.bb
  store i32 %21, i32* %17, align 8
  %31 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %16, i32 0, i32 2
  %32 = bitcast %union.anon.6* %31 to i8*
  %33 = load i8, i8* %32, align 8
  %34 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %vptr2, i32 0, i32 2
...
casenum.bb:                                       ; preds = %copy.bb
  store i32 %21, i32* %17, align 8
  %36 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %16, i32 0, i32 2
  ...
  %44 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %vptr2, i32 0, i32 2
