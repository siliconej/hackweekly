...
init.bb:
  ...
  %ptr4 = alloca [4 x %"cls.acjs::JsVariant"*], align 16
...
exec.bb:                                          ; preds = %init.bb
  %19 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEx(%"cls.acjs::JsVariant"* %ptr, i64 1)
  %20 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEx(%"cls.acjs::JsVariant"* %ptr1, i64 2)
  %21 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEx(%"cls.acjs::JsVariant"* %ptr2, i64 3)
  %22 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEx(%"cls.acjs::JsVariant"* %ptr3, i64 4)
  %newalloc = call i8* @_Znam(i64 232)
  %23 = bitcast i8* %newalloc to i64*
  store i64 4, i64* %23, align 16
  %24 = getelementptr inbounds i8, i8* %newalloc, i64 8
  %25 = bitcast i8* %24 to %"cls.acjs::JsVariant"*
  %26 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %25, i64 4
  %27 = getelementptr inbounds [4 x %"cls.acjs::JsVariant"*], [4 x %"cls.acjs::JsVariant"*]* %ptr4, i32 0, i32 0
  br label %initarr.bb

exit.bb:                                          ; preds = %ixexit.bb10
  %28 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %0, %"cls.acjs::JsVariant"* dereferenceable(56) %ptr13)
...
initarr.bbe:                                      ; preds = %initarr.bb
  ...
  %34 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %33, %"cls.acjs::JsVariant"* %ptr)
  ...
  %37 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %36, %"cls.acjs::JsVariant"* %ptr1)
  ...
  %39 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %25, i64 2
  %40 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %39, %"cls.acjs::JsVariant"* %ptr2)
  %41 = getelementptr inbounds %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"** %27, i64 2
  store %"cls.acjs::JsVariant"* %39, %"cls.acjs::JsVariant"** %41, align 8
  %42 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %25, i64 3
  %43 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %42, %"cls.acjs::JsVariant"* %ptr3)
  %44 = getelementptr inbounds %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"** %27, i64 3
  store %"cls.acjs::JsVariant"* %42, %"cls.acjs::JsVariant"** %44, align 8
  %45 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEN4llvm8ArrayRefIPS1_EE(%"cls.acjs::JsVariant"* %ptr5, %"cls.acjs::JsVariant"** %27, i64 4)
  %46 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %ptr6, %"cls.acjs::JsVariant"* %ptr5)
  %47 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %ptr6, i32 0, i32 1
  %48 = load i32, i32* %47, align 8
  %49 = icmp eq i32 %48, 13
  %50 = icmp eq i32 %48, 11
  %51 = or i1 %49, %50
  %52 = icmp eq i32 %48, 14
  %53 = icmp eq i32 %48, 12
  %54 = or i1 %52, %53
  %55 = or i1 %51, %54
  br i1 %55, label %ixaccess.bb, label %ixonly.bb

ixaccess.bb:                                      ; preds = %initarr.bbe
  %56 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantixEj(%"cls.acjs::JsVariant"* %ptr6, i32 10)
  br label %ixexit.bb

ixonly.bb:                                        ; preds = %initarr.bbe
  call void @_ZNK14altered_carbon2js9JsVariantixEj(%"cls.acjs::JsVariant"* %ptr7, %"cls.acjs::JsVariant"* %ptr6, i32 10)
  br label %ixexit.bb

ixexit.bb:                                        ; preds = %ixonly.bb, %ixaccess.bb
  %subscript = phi %"cls.acjs::JsVariant"* [ %56, %ixaccess.bb ], [ %ptr7, %ixonly.bb ]
  %57 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEx(%"cls.acjs::JsVariant"* %subscript, i64 5)
  %58 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %ptr6, i32 0, i32 1
  %59 = load i32, i32* %58, align 8
  %60 = icmp eq i32 %59, 13
  %61 = icmp eq i32 %59, 11
  %62 = or i1 %60, %61
  %63 = icmp eq i32 %59, 14
  %64 = icmp eq i32 %59, 12
  %65 = or i1 %63, %64
  %66 = or i1 %62, %65
  br i1 %66, label %ixaccess.bb8, label %ixonly.bb9

ixaccess.bb8:                                     ; preds = %ixexit.bb
  %67 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantixEj(%"cls.acjs::JsVariant"* %ptr6, i32 100)
  br label %ixexit.bb10

ixonly.bb9:                                       ; preds = %ixexit.bb
  call void @_ZNK14altered_carbon2js9JsVariantixEj(%"cls.acjs::JsVariant"* %ptr11, %"cls.acjs::JsVariant"* %ptr6, i32 100)
  br label %ixexit.bb10

ixexit.bb10:                                      ; preds = %ixonly.bb9, %ixaccess.bb8
  %subscript12 = phi %"cls.acjs::JsVariant"* [ %67, %ixaccess.bb8 ], [ %ptr11, %ixonly.bb9 ]
  %68 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEx(%"cls.acjs::JsVariant"* %subscript12, i64 10)
  %69 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %ptr13, %"cls.acjs::JsVariant"* %ptr6)
  br label %exit.bb
}
