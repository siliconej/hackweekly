...
@.wstr = private unnamed_addr constant [8 x i32] [i32 74, i32 97, i32 110, i32 117, i32 97, i32 114, i32 121, i32 0], align 4
@.wstr.1 = private unnamed_addr constant [9 x i32] [i32 70, i32 101, i32 98, i32 114, i32 117, i32 97, i32 114, i32 121, i32 0], align 4
@.wstr.2 = private unnamed_addr constant [6 x i32] [i32 77, i32 97, i32 114, i32 99, i32 104, i32 0], align 4
...
exec.bb:                                          ; preds = %init.bb
  %11 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEPKw(%"cls.acjs::JsVariant"* %ptr, i32* getelementptr inbounds ([8 x i32], [8 x i32]* @.wstr, i32 0, i32 0))
  %12 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEPKw(%"cls.acjs::JsVariant"* %ptr1, i32* getelementptr inbounds ([9 x i32], [9 x i32]* @.wstr.1, i32 0, i32 0))
  %13 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEPKw(%"cls.acjs::JsVariant"* %ptr2, i32* getelementptr inbounds ([6 x i32], [6 x i32]* @.wstr.2, i32 0, i32 0))
  %newalloc = call i8* @_Znam(i64 176)
  %14 = bitcast i8* %newalloc to i64*
  store i64 3, i64* %14, align 16
  %15 = getelementptr inbounds i8, i8* %newalloc, i64 8
  %16 = bitcast i8* %15 to %"cls.acjs::JsVariant"*
  %17 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %16, i64 3
  %18 = getelementptr inbounds [3 x %"cls.acjs::JsVariant"*], [3 x %"cls.acjs::JsVariant"*]* %ptr3, i32 0, i32 0
  br label %initarr.bb
...
initarr.bb:                                       ; preds = %initarr.bb, %exec.bb
  %iter = phi %"cls.acjs::JsVariant"* [ %16, %exec.bb ], [ %22, %initarr.bb ]
  ...
  %23 = icmp eq %"cls.acjs::JsVariant"* %22, %17
  br i1 %23, label %initarr.bbe, label %initarr.bb

initarr.bbe:                                      ; preds = %initarr.bb
  %24 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %16, i64 0
  %25 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %24, %"cls.acjs::JsVariant"* %ptr)
  %26 = getelementptr inbounds %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"** %18, i64 0
  store %"cls.acjs::JsVariant"* %24, %"cls.acjs::JsVariant"** %26, align 8
  %27 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %16, i64 1
  %28 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %27, %"cls.acjs::JsVariant"* %ptr1)
  %29 = getelementptr inbounds %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"** %18, i64 1
  store %"cls.acjs::JsVariant"* %27, %"cls.acjs::JsVariant"** %29, align 8
  %30 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %16, i64 2
  %31 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %30, %"cls.acjs::JsVariant"* %ptr2)
  %32 = getelementptr inbounds %"cls.acjs::JsVariant"*, %"cls.acjs::JsVariant"** %18, i64 2
  store %"cls.acjs::JsVariant"* %30, %"cls.acjs::JsVariant"** %32, align 8
  %33 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEN4llvm8ArrayRefIPS1_EE(%"cls.acjs::JsVariant"* %ptr4, %"cls.acjs::JsVariant"** %18, i64 3)
  %34 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %ptr5, %"cls.acjs::JsVariant"* %ptr4)
  br label %exit.bb
}
