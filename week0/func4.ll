...
init.bb:
  ...
  %1 = bitcast %"cls.acjs::JsVariant"* %ptr1 to i32 (...)***
  ...
  %2 = getelementptr inbounds %"cls.acjs::JsVariant", %"cls.acjs::JsVariant"* %ptr1, i32 0, i32 1
  store i32 1, i32* %2, align 8
  br label %exec.bb

exec.bb:                                          ; preds = %init.bb
  %3 = getelementptr inbounds [0 x %"cls.acjs::JsVariant"*], [0 x %"cls.acjs::JsVariant"*]* %ptr, i32 0, i32 0
  call void @_ZN3_js4testEPN14altered_carbon2js9JsVariantEN4llvm8ArrayRefIS3_EE(%"cls.acjs::JsVariant"* %ptr1, %"cls.acjs::JsVariant"* null, %"cls.acjs::JsVariant"** %3, i64 0)
  br label %exit.bb

exit.bb:                                          ; preds = %exec.bb
  %4 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %0, %"cls.acjs::JsVariant"* dereferenceable(56) %ptr1)
...
block:                                            ; preds = %exec.bb
  %6 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEb(%"cls.acjs::JsVariant"* %ptr, i1 zeroext true)
