...
exec.bb:                                          ; preds = %init.bb
  ...
  %12 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEx(%"cls.acjs::JsVariant"* %ptr1, i64 2)
  %13 = call i1 @_ZNK14altered_carbon2js9JsVariantgtERKS1_(%"cls.acjs::JsVariant"* %ptr, %"cls.acjs::JsVariant"* %ptr1)
  %14 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantC1Eb(%"cls.acjs::JsVariant"* %ptr3, i1 zeroext %13)
  %15 = call i1 @_ZNK14altered_carbon2js9JsVariant9asBooleanEv(%"cls.acjs::JsVariant"* %ptr3)
  %16 = icmp ne i1 %15, false
  br i1 %16, label %ret.lhs, label %ret.rhs

exit.bb:                                          ; preds = %ret.op
  %17 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %0, %"cls.acjs::JsVariant"* dereferenceable(56) %result)
...
ret.lhs:                                          ; preds = %exec.bb
  %18 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEx(%"cls.acjs::JsVariant"* %ptr4, i64 3)
  br label %ret.op
...
ret.op:                                           ; preds = %ret.rhs, %ret.lhs
  %result = phi %"cls.acjs::JsVariant"* [ %ptr4, %ret.lhs ], [ %ptr3, %ret.rhs ]
  br label %exit.bb
}
