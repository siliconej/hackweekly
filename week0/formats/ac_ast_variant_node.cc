...
ACAstVariantNode::ACAstVariantNode(PPOSITION pos, bool v)
    : ACAstBaseNode(std::move(pos), AST_VAR, AST_BOOL_VARIANT),
      bool_value_(v) {}

ACAstVariantNode::ACAstVariantNode(PPOSITION pos, ACLexNumber v)
    : ACAstBaseNode(std::move(pos), AST_VAR, AST_NUMERIC_VARIANT),
      numeric_value_(v) {}
...
ACAstVariantNode::ACAstVariantNode(PPOSITION pos)
    : ACAstBaseNode(std::move(pos), AST_VAR, AST_SPECIAL_VARIANT),
      type_(TK_UNDEFINED) {}
...
ACAstVariantNode::ACAstVariantNode(PPOSITION pos, PLEXREGEX regex)
    : ACAstBaseNode(std::move(pos), AST_VAR, AST_REGEX_VARIANT),
