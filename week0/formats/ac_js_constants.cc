...
const int ACJsConstants::OPERATOR_PRECEDENCE[] =
    {  // Maps to ACTokenType [101, 122].
        /* 101: TK_OP_BOOL_OR */ 1,
...
const char *ACJsConstants::RESERVED_WORDS[] =
    {  // Maps to ACTokenType [200, 257].
        "abstract",     "boolean",    "break",
        "byte",         "case",  // 200 ~ 204
        "catch",        "char",       "class",
        "const",        "continue",  // 205 ~ 219
        "debugger",     "default",    "delete",
        "do",           "double",  // 210 ~ 214
        "else",         "enum",       "export",
        "extends",      "final",  // 215 ~ 229
        "finally",      "float",      "for",
        "function",     "goto",  // 220 ~ 224
        "if",           "implements", "import",
        "in",           "instanceof",  // 225 ~ 229
        "int",          "interface",  "let",
        "long",         "native",  // 230 ~ 234
        "new",          "package",    "private",
        "protected",    "public",  // 235 ~ 239
        "return",       "short",      "static",
        "super",        "switch",  // 240 ~ 244
        "synchronized", "this",       "throw",
        "throws",       "transient",  // 245 ~ 249
        "try",          "typeof",     "var",
        "void",         "volatile",              // 250 ~ 254
