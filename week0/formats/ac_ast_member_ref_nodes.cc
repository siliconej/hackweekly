...
ACAstStaticMemberRef::ACAstStaticMemberRef(PPOSITION pos, PBaseNode object,
                                           PBaseNode member_id)
    : ACAstExpressionNode(std::move(pos), std::move(object), AST_MEMBER_REF,
                          AST_COMPUTED_MEMBER_REF) {
...
ACAstRuntimeMemberRef::ACAstRuntimeMemberRef(PPOSITION pos, PBaseNode object,
                                             PBaseNode member_expr)
    : ACAstExpressionNode(std::move(pos), std::move(object), AST_MEMBER_REF,
                          AST_NON_COMPUTED_MEMBER_REF) {
