...
exit.bb:                                          ; preds = %exit.bb4
  %23 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSERKS1_(%"cls.acjs::JsVariant"* %0, %"cls.acjs::JsVariant"* dereferenceable(56) %ptr10)
...
inc.bb:                                           ; preds = %ret.op, %block
  %30 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantaSEx(%"cls.acjs::JsVariant"* %ptr9, i64 1)
  %31 = call %"cls.acjs::JsVariant"* @_ZN14altered_carbon2js9JsVariantpLERKS1_(%"cls.acjs::JsVariant"* %ptr3, %"cls.acjs::JsVariant"* %ptr9)
  br label %cond.bb

exit.bb4:                                         ; preds = %block8
...
block8:                                           ; preds = %ret.rhs
  br label %exit.bb4

block8e:                                          ; No predecessors!
  br label %ret.op
}
