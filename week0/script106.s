...
## %bb.107:                             ## %copy.bb86
	...
	addq	%rdx, %rcx
	jmpq	*%rcx
LBB0_115:                               ## %casenul_unf.bb89
                                        ##   in Loop: Header=BB0_29 Depth=2
	movl	%eax, 8(%rbx)
	jmp	LBB0_109
	.p2align	4, 0x90
LBB0_108:                               ## %fallback.bb87
                                        ##   in Loop: Header=BB0_29 Depth=2
	movq	%rbx, %rdi
	movq	%r15, %rsi
	callq	__ZN14altered_carbon2js9JsVariantaSERKS1_
...
## %bb.122:                             ## %copy.bb97
	...
	addq	%rdx, %rcx
	jmpq	*%rcx
LBB0_125:                               ## %casenul_unf.bb100
                                        ##   in Loop: Header=BB0_29 Depth=2
	movl	%eax, 8(%rbx)
	jmp	LBB0_128
	.p2align	4, 0x90
LBB0_123:                               ## %fallback.bb98
                                        ##   in Loop: Header=BB0_29 Depth=2
	leaq	-200(%rbp), %rsi
	movq	%rbx, %rdi
	callq	__ZN14altered_carbon2js9JsVariantaSERKS1_
	jmp	LBB0_128
LBB0_114:                               ## %caseerr.bb88
                                        ##   in Loop: Header=BB0_29 Depth=2
	movl	%eax, 8(%rbx)
	movq	16(%r15), %rax
	movq	%rax, 16(%rbx)
	jmp	LBB0_109
LBB0_117:                               ## %casenum.bb91
                                        ##   in Loop: Header=BB0_29 Depth=2
	movl	%eax, 8(%rbx)
	movq	16(%r15), %rax
	...
	movb	%cl, 32(%rbx)
	jmp	LBB0_109
LBB0_116:                               ## %casebln.bb90
                                        ##   in Loop: Header=BB0_29 Depth=2
	movl	%eax, 8(%rbx)
	movb	16(%r15), %al
	movb	%al, 16(%rbx)
	jmp	LBB0_109
LBB0_124:                               ## %caseerr.bb99
                                        ##   in Loop: Header=BB0_29 Depth=2
	movl	%eax, 8(%rbx)
	movq	-184(%rbp), %rax
	movq	%rax, 16(%rbx)
	jmp	LBB0_128
LBB0_127:                               ## %casenum.bb102
                                        ##   in Loop: Header=BB0_29 Depth=2
	movl	%eax, 8(%rbx)
	movq	-184(%rbp), %rax
...
## %bb.16:                              ## %copy.bb109
	...
	addq	%rdx, %rcx
	jmpq	*%rcx
LBB0_131:                               ## %casenul_unf.bb112
	movl	%eax, -248(%rbp)
	jmp	LBB0_134
LBB0_129:                               ## %fallback.bb110
	leaq	-256(%rbp), %rdi
	leaq	-88(%rbp), %rsi
	callq	__ZN14altered_carbon2js9JsVariantaSERKS1_
LBB0_134:                               ## %copy.bb109e
	leaq	-256(%rbp), %rbx
	movq	%r14, %rdi
	movq	%rbx, %rsi
	callq	__ZN14altered_carbon2js9JsVariantaSERKS1_
...
LBB0_9:                                 ## %casebln.bb
	...
	jge	LBB0_17
	jmp	LBB0_12
LBB0_130:                               ## %caseerr.bb111
	movl	%eax, -248(%rbp)
	movq	-72(%rbp), %rax
	movq	%rax, -240(%rbp)
	jmp	LBB0_134
LBB0_133:                               ## %casenum.bb114
	movl	%eax, -248(%rbp)
	movq	-72(%rbp), %rax
