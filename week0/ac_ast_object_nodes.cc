...
/////////////////////////////////////////////////////////////////////////////////
ACAstObjectInitProperty::ACAstObjectInitProperty(PPOSITION pos,
    PBaseNode key, PBaseNode value,
    bool is_runtime, bool is_method, bool is_shorthand) :
  ACAstBaseNode(std::move(pos), AST_OBJECT, AST_OBJECT_INIT_PROPERTY),
  key_(std::move(key)), value_(std::move(value)),
  is_runtime_(is_runtime), is_method_(is_method), is_shorthand_(is_shorthand) {}
